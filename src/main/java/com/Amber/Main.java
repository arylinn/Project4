...
public class Main {
    public static void main(String[] args) {
        TodoAPIWrapper todoAPI = new TodoAPIWrapper("amber", "amber",
                "http://todo.eastus.cloudapp.azure.com/todo-android");

        System.out.println("Adding todos");
        todoAPI.createTodo("Homework", "Do homework due today", 5);
        todoAPI.createTodo("Dinner", "Find something for dinner", 3);
        todoAPI.createTodo("Dog", "Walk Neo", 4);
        todoAPI.createTodo("Movies", "Look up movie times", 2);
